...
| 6. Feature fix | [`src/features.py`](src/features.py) | Live-testing the dashboard found the model flagging legitimate account closures as 100% fraud: why it happened, and how it was fixed |
